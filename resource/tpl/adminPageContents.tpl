...
<!--form for save-->		
<!-- header -->
<form   method="GET" id="applicationform_search_form" name="applicationform_search_form" >
...
<div class="table_header_area">
    <ul class="row_1">
        ...
        <select id="applicationform_search_field" name="applicationform_search_field" >
            ...
            <a href="javascript:adminPageContents.submit_form();" class="btn_nor_01 btn_width_st1" title="Search Photo Gallery">Search</a>
    ...
    <ul class="row_2">
        <li>
    <a href="javascript:adminPageContents.delete_list_process();"  class="btn_nor_01 btn_width_st1">Remove</a></li>                <li class="show">
...
<table border="1" cellpadding="0" cellspacing="0" class="table_hor_02" id="table_list" >
	...
	<tbody>
		...
		<?php foreach($aData as $key=>$val){?>
			...
			<td><?php echo $val['num'];?></td><td><a href="javascript:adminPageContents.show_info(<?php echo $val['idx'];?>);" ><?php echo $val['name'];?></a></td><td><?php echo $val['position'];?></td>
...
<div class="tbl_lb_wide_btn">
		<a href="#" class="btn_apply" onclick="adminPageContents.setting_submit()" />Save</a>
		<a href="#" class="add_link" title="Reset to default" onclick="adminPageContents.reset_default()" >Reset to Default</a>
</div>
-->
...
<div id='<?php echo $APP_NAME;?>_popup' style='display:none'>
	...
	<br />
	<br />
	<a class="btn_apply" href="javascript: void(0);" style='cursor:pointer' title="Delete" onclick="adminPageContents.delete_from_list();"> Delete </a>
	</div>
</div>
